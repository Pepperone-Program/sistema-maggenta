...
export const resources: Record<string, ResourceConfig> = {
  "landing-pages": {
    ...
    idField: "id",
    searchPlaceholder: "Buscar por titulo, slug, descricao, palavras-chave ou URL",
    ...
    formFields: [
      ...
      { name: "slug", label: "Slug", maxLength: 200, required: true },
  ...
  orcamentos: {
    ...
    formFields: [
      { name: "data_orcamento", label: "Data", type: "date" },
      { name: "fantasia", label: "Fantasia" },
